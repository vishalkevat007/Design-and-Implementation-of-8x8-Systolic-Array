...
# Generated on: Sun Apr 27 23:28:57 EDT 2025 (Mon Apr 28 03:28:57 UTC 2025)
...
set logfile fv/tpu_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/tpu_top -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/package/eda/cadence/GENUS211.7/tools.lnx86"
set CDN_SYNTH_ROOT      "/package/eda/cadence/GENUS211.7/tools.lnx86"
set env(CW_DIR) "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware"
set CW_DIR      "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/package/eda/cadence/GENUS211.7/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS -keep_unreach -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/tpu_top.v ../RTL/addr_sel.v ../RTL/quantize.v ../RTL/systolic.v ../RTL/systolic_controll.v ../RTL/write_out.v
elaborate_design -golden -root {tpu_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/tpu_top/fv_map.v.gz
elaborate_design -revised -root {tpu_top}
...
#add_name_alias fv/tpu_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.tpu_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.tpu_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.tpu_top.rtl.fv_map.rpt
